...
# Локальный сервер (main.py): 127.0.0.1. Удалённый — подставьте IP машины с сервером.
HOST = "10.3.1.147"
PORT = 5000

# Лёгкая проверка «сервер жив» без диагностики и без остановки процесса (не используйте stop для этого).
